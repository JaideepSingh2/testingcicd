...
<body>
    ...
    <form id="searchForm" method="post">
        <div><label for="GID">Enter Gallery ID:</label><input type="text" id="GID" name="GID" placeholder="GID"></div>
...
$dbname = "agms";
            ...
            if($a!="")
            {
                ...
                if(mysqli_num_rows($result)>0)
                {
                    ...
                    echo "<table>";
                    echo "<tr><th>GID</th><th>LOCATION</th><th>GNAME</th></tr>";
                    echo "<tr><td>" . $row["GID"] . "</td><td>" . $row["LOCATION"] . "</td><td>" . $row["GNAME"] . "</td></tr>";
                    echo "</table>";
                }
                else
                {
                ...
                echo "<b class='error-message'>GID Field is Empty</b>";
            }
            $con->close();
        }
        ?>
