...
<html>
<head>
    <title>Insertion in Exhibition</title>
...
$dbname = "agms";
        ...
        $result = $conn->query("CALL GetArtworksInexhibition($exhibitionid)");
        if ($result->num_rows > 0) {
            echo "<table><tr><th>ARTID</th><th>TITLE</th></tr>";
            // output data of each row
            while($row = $result->fetch_assoc()) {
                echo "<tr><td>".$row["ARTID"]."</td><td>".$row["TITLE"]."</td></tr>";
            }
            echo "</table>";
        } else {
