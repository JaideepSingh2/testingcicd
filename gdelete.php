...
<body>
    <h1>Delete from Gallery Table</h1>
    <form id="deleteForm" method="post">
        <div><label for="G_ID">Enter Gallery ID:</label><input type="text" id="G_ID" name="G_ID" placeholder="GID"></div>
...
$dbname = "agms";
            ...
            if($a!="")
            {
                ...
                if(mysqli_num_rows($result)>0)
                {
                    ...
                    echo "<b>Record with GID = $a is deleted successfully.<b>";
                }
                else
                {
